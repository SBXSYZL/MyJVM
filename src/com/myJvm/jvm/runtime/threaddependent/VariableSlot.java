...
import com.myJvm.jvm.runtime.threaddependent.impl.VariableSlotNumber;
import com.myJvm.jvm.runtime.threaddependent.impl.VariableSlotObject;
import com.myJvm.utils.LongUtil;
...
public interface VariableSlot {
    ...
    static VariableSlot createVariableSlot(Object value) {
        try {
            if (value instanceof VariableSlot) {
                return (VariableSlot) value;
            }

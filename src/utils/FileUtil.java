...
public class FileUtil {
    ...
    public static synchronized void printTree(MyClass myClass) {
        ...
        //类头
        builder.append(AccessPermission.getAccessFlagString(myClass.getAccessFlag()))
                .append(" ")
        ...
        for (MyField field : fields) {
            builder.append("\t")
                    .append(AccessPermission.getAccessFlagString(field.getAccessFlag()));
        ...
        for (MyMethod method : methods) {
            ...
            builder.append("\t")
                    .append(AccessPermission.getAccessFlagString(method.getAccessFlag()))
                    .append(" ");
